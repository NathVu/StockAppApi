...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "6444cb2239074154e75b";
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __generator = (this && this.__generator) || function (thisArg, body) {\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;\n    return g = { next: verb(0), \"throw\": verb(1), \"return\": verb(2) }, typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\n    function verb(n) { return function (v) { return step([n, v]); }; }\n    function step(op) {\n        if (f) throw new TypeError(\"Generator is already executing.\");\n        while (_) try {\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\n            if (y = 0, t) op = [op[0] & 2, t.value];\n            switch (op[0]) {\n                case 0: case 1: t = op; break;\n                case 4: _.label++; return { value: op[1], done: false };\n                case 5: _.label++; y = op[1]; op = [0]; continue;\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\n                default:\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\n                    if (t[2]) _.ops.pop();\n                    _.trys.pop(); continue;\n            }\n            op = body.call(thisArg, _);\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\n    }\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.company = void 0;\nvar express_1 = __importDefault(__webpack_require__(/*! express */ \"express\"));\nvar request = __webpack_require__(/*! request-promise */ \"request-promise\");\nvar KEY = process.env.KEY;\nvar companyApp = express_1.default();\ncompanyApp.get('/GetNews', getNewsRequest);\ncompanyApp.get('/GetCompanyProfile', getCompanyProfile);\nexports.company = companyApp;\nfunction getNewsRequest(req, res) {\n    return __awaiter(this, void 0, void 0, function () {\n        var items, apiKey, result, e_1;\n        return __generator(this, function (_a) {\n            switch (_a.label) {\n                case 0:\n                    _a.trys.push([0, 2, , 3]);\n                    items = void 0;\n                    apiKey = KEY;\n                    console.log(apiKey);\n                    try {\n                        items = req.body;\n                        console.log(items);\n                    }\n                    catch (e) {\n                        res.status(400).send('Bad Request');\n                        return [2 /*return*/];\n                    }\n                    return [4 /*yield*/, request('https://finnhub.io/api/v1/company-news?symbol=' + items.ticker + '&from=' + items.from + '&to=' + items.to + '&token=' + apiKey, { json: true }, function (err, res, body) {\n                            if (err) {\n                                console.log(err);\n                                res.status(500).send('Something went wrong');\n                                return;\n                            }\n                        })];\n                case 1:\n                    result = _a.sent();\n                    console.log(result);\n                    res.status(200).send(JSON.stringify(result));\n                    return [3 /*break*/, 3];\n                case 2:\n                    e_1 = _a.sent();\n                    res.status(404).send(e_1.message);\n                    return [3 /*break*/, 3];\n                case 3: return [2 /*return*/];\n            }\n        });\n    });\n}\nfunction getCompanyProfile(req, res) {\n    return __awaiter(this, void 0, void 0, function () {\n        var items, apiKey, result;\n        return __generator(this, function (_a) {\n            try {\n                items = void 0;\n                apiKey = KEY;\n                try {\n                    items = req.body;\n                    console.log(items);\n                }\n                catch (e) {\n                    res.status(400).send('Bad Request');\n                    return [2 /*return*/];\n                }\n                result = request('https://finnhub.io/api/v1/stock/profile2?symbol=' + items.ticker + '&token=' + apiKey, { json: true }, function (err, res, body) {\n                    if (err) {\n                        console.log(err);\n                        res.status(500).send('Something went wrong');\n                        return;\n                    }\n                });\n                console.log(result);\n                res.status(200).send(JSON.stringify(result));\n            }\n            catch (e) {\n                res.status(404).send(e.message);\n            }\n            return [2 /*return*/];\n        });\n    });\n}\n\n\n//# sourceURL=webpack:///./src/company.ts?");
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __generator = (this && this.__generator) || function (thisArg, body) {\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;\n    return g = { next: verb(0), \"throw\": verb(1), \"return\": verb(2) }, typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\n    function verb(n) { return function (v) { return step([n, v]); }; }\n    function step(op) {\n        if (f) throw new TypeError(\"Generator is already executing.\");\n        while (_) try {\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\n            if (y = 0, t) op = [op[0] & 2, t.value];\n            switch (op[0]) {\n                case 0: case 1: t = op; break;\n                case 4: _.label++; return { value: op[1], done: false };\n                case 5: _.label++; y = op[1]; op = [0]; continue;\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\n                default:\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\n                    if (t[2]) _.ops.pop();\n                    _.trys.pop(); continue;\n            }\n            op = body.call(thisArg, _);\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\n    }\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.news = void 0;\nvar express_1 = __importDefault(__webpack_require__(/*! express */ \"express\"));\nvar request = __webpack_require__(/*! request-promise */ \"request-promise\");\nvar KEY = process.env.KEY;\nvar newsApp = express_1.default();\nnewsApp.get('/', getGeneralNewsRequest);\nexports.news = newsApp;\nfunction getGeneralNewsRequest(req, res) {\n    return __awaiter(this, void 0, void 0, function () {\n        var apiKey, result, e_1;\n        return __generator(this, function (_a) {\n            switch (_a.label) {\n                case 0:\n                    _a.trys.push([0, 2, , 3]);\n                    apiKey = KEY;\n                    console.log(apiKey);\n                    return [4 /*yield*/, request('https://finnhub.io/api/v1/news?category=general&token=' + apiKey, { json: true }, function (err, res, body) {\n                            if (err) {\n                                res.status(500).send(err);\n                                return;\n                            }\n                        })];\n                case 1:\n                    result = _a.sent();\n                    res.status(200).send(result);\n                    return [3 /*break*/, 3];\n                case 2:\n                    e_1 = _a.sent();\n                    res.status(404).send(e_1.message);\n                    return [3 /*break*/, 3];\n                case 3: return [2 /*return*/];\n            }\n        });\n    });\n}\n\n\n//# sourceURL=webpack:///./src/news.ts?");
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __generator = (this && this.__generator) || function (thisArg, body) {\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;\n    return g = { next: verb(0), \"throw\": verb(1), \"return\": verb(2) }, typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\n    function verb(n) { return function (v) { return step([n, v]); }; }\n    function step(op) {\n        if (f) throw new TypeError(\"Generator is already executing.\");\n        while (_) try {\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\n            if (y = 0, t) op = [op[0] & 2, t.value];\n            switch (op[0]) {\n                case 0: case 1: t = op; break;\n                case 4: _.label++; return { value: op[1], done: false };\n                case 5: _.label++; y = op[1]; op = [0]; continue;\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\n                default:\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\n                    if (t[2]) _.ops.pop();\n                    _.trys.pop(); continue;\n            }\n            op = body.call(thisArg, _);\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\n    }\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.ticker = void 0;\nvar express_1 = __importDefault(__webpack_require__(/*! express */ \"express\"));\nvar request = __webpack_require__(/*! request-promise */ \"request-promise\");\nvar KEY = process.env.KEY;\nvar tickerApp = express_1.default();\ntickerApp.get('/GetQuote', getQuoteRequest);\ntickerApp.post('/GetCandles', getCandlesRequest);\nexports.ticker = tickerApp;\nfunction getQuoteRequest(req, res) {\n    return __awaiter(this, void 0, void 0, function () {\n        var items, apikey, result, e_1;\n        return __generator(this, function (_a) {\n            switch (_a.label) {\n                case 0:\n                    _a.trys.push([0, 2, , 3]);\n                    items = void 0;\n                    apikey = KEY;\n                    console.log(apikey);\n                    try {\n                        items = req.body;\n                    }\n                    catch (e) {\n                        res.status(400).send('Bad Request');\n                        return [2 /*return*/];\n                    }\n                    return [4 /*yield*/, request('https://finnhub.io/api/v1/quote?symbol=' + items.ticker + '&token=' + apikey, { json: true }, function (err, res, body) {\n                            if (err) {\n                                return console.log(err);\n                            }\n                        })];\n                case 1:\n                    result = _a.sent();\n                    res.status(200).send(JSON.stringify(result));\n                    return [3 /*break*/, 3];\n                case 2:\n                    e_1 = _a.sent();\n                    res.status(500).send(e_1.message);\n                    return [3 /*break*/, 3];\n                case 3: return [2 /*return*/];\n            }\n        });\n    });\n}\nfunction getCandlesRequest(req, res) {\n    return __awaiter(this, void 0, void 0, function () {\n        var items, apikey, result, e_2;\n        return __generator(this, function (_a) {\n            switch (_a.label) {\n                case 0:\n                    _a.trys.push([0, 2, , 3]);\n                    items = void 0;\n                    apikey = KEY;\n                    console.log(apikey);\n                    try {\n                        items = req.body;\n                        console.log(req);\n                    }\n                    catch (e) {\n                        res.status(400).send('Bad Request');\n                        return [2 /*return*/];\n                    }\n                    return [4 /*yield*/, request('https://finnhub.io/api/v1/stock/candle?symbol=' + items.symbol + '&resolution=' + items.resolution + '&from=' + items.from + '&to=' + items.to + '&token=' + apikey, { json: true }, function (err, res, body) {\n                            if (err) {\n                                return console.log(err);\n                            }\n                        })];\n                case 1:\n                    result = _a.sent();\n                    res.status(200).send(JSON.stringify(result));\n                    return [3 /*break*/, 3];\n                case 2:\n                    e_2 = _a.sent();\n                    res.status(500).send(e_2.message);\n                    return [3 /*break*/, 3];\n                case 3: return [2 /*return*/];\n            }\n        });\n    });\n}\n\n\n//# sourceURL=webpack:///./src/tickers.ts?");
